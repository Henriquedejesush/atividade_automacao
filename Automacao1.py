...
def selecionar_arquivo(escolher_arquivo,delay=2):
    espera(delay)
    pyautogui.write(escolher_arquivo)
    espera(delay)
    pyautogui.press("enter")
...
enviar_email("mateusgn@to.senac.br") # Colocar email de destino
...
clique1(1426, 997) # clicar em opcao de enviar arquivos
clique1(80, 260) # clicar em documentos
dois_cliques2(471, 241) # clicar em pasta projetos_python
clique1(540, 184) # clicar em pasta venv
clique1(819, 51) # clicar em pesquisar arquivos
selecionar_arquivo("Automacao1.py") # procurar arquivo
clique1(523, 146) #Clicar em arquivo
clique1(799, 497) # abrir arquivo
clique1(1304, 1000) #enviar arquivo
